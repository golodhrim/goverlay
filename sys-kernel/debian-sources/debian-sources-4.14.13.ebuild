...
SRC_URI="http://http.debian.net/debian/pool/main/l/linux/linux_4.14.13.orig.tar.xz http://http.debian.net/debian/pool/main/l/linux/linux_4.14.13-1.debian.tar.xz"
S="$WORKDIR/linux-${CKV}"
